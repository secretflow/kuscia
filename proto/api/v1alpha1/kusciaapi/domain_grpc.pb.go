...
func (c *domainServiceClient) CreateDomain(ctx context.Context, in *CreateDomainRequest, opts ...grpc.CallOption) (*CreateDomainResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/kuscia.proto.api.v1alpha1.kusciaapi.DomainService/CreateDomain", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *domainServiceClient) QueryDomain(ctx context.Context, in *QueryDomainRequest, opts ...grpc.CallOption) (*QueryDomainResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/kuscia.proto.api.v1alpha1.kusciaapi.DomainService/QueryDomain", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *domainServiceClient) UpdateDomain(ctx context.Context, in *UpdateDomainRequest, opts ...grpc.CallOption) (*UpdateDomainResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/kuscia.proto.api.v1alpha1.kusciaapi.DomainService/UpdateDomain", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *domainServiceClient) DeleteDomain(ctx context.Context, in *DeleteDomainRequest, opts ...grpc.CallOption) (*DeleteDomainResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/kuscia.proto.api.v1alpha1.kusciaapi.DomainService/DeleteDomain", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *domainServiceClient) BatchQueryDomainStatus(ctx context.Context, in *BatchQueryDomainStatusRequest, opts ...grpc.CallOption) (*BatchQueryDomainStatusResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/kuscia.proto.api.v1alpha1.kusciaapi.DomainService/BatchQueryDomainStatus", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _DomainService_CreateDomain_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/kuscia.proto.api.v1alpha1.kusciaapi.DomainService/CreateDomain",
	}
...
func _DomainService_QueryDomain_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/kuscia.proto.api.v1alpha1.kusciaapi.DomainService/QueryDomain",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _DomainService_UpdateDomain_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/kuscia.proto.api.v1alpha1.kusciaapi.DomainService/UpdateDomain",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _DomainService_DeleteDomain_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/kuscia.proto.api.v1alpha1.kusciaapi.DomainService/DeleteDomain",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _DomainService_BatchQueryDomainStatus_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/kuscia.proto.api.v1alpha1.kusciaapi.DomainService/BatchQueryDomainStatus",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
