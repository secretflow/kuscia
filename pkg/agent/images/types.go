...
type ImageManager interface {
	...
	EnsureImageExists(pod *v1.Pod, container *v1.Container, auth *credentialprovider.AuthConfig, podSandboxConfig *runtimeapi.PodSandboxConfig) (string, string, error)
