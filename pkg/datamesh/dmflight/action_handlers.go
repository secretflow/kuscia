...
type DataMeshCustomActionHandlers interface {
...
type dmCustomActionHandlers struct {
	domainDataService       service.IDomainDataService
	domainDataSourceService service.IDomainDataSourceService
}

func NewDataMeshCustomActionHandlers(domainDataService service.IDomainDataService, dataSourceService service.IDomainDataSourceService) DataMeshCustomActionHandlers {
	return &dmCustomActionHandlers{
		domainDataService:       domainDataService,
		domainDataSourceService: dataSourceService,
	}
}

func (s *dmCustomActionHandlers) DoActionCreateDomainDataRequest(ctx context.Context, body []byte) (*flight.Result, error) {
	...
	return PackActionResult(domainDataResp)
}

func (s *dmCustomActionHandlers) DoActionQueryDomainDataRequest(ctx context.Context, body []byte) (*flight.Result, error) {
...
func (s *dmCustomActionHandlers) DoActionUpdateDomainDataRequest(ctx context.Context, body []byte) (*flight.Result, error) {
...
func (s *dmCustomActionHandlers) DoActionDeleteDomainDataRequest(ctx context.Context, body []byte) (*flight.Result, error) {
...
func (s *dmCustomActionHandlers) DoActionQueryDomainDataSourceRequest(ctx context.Context, body []byte) (*flight.Result, error) {
	...
	return PackActionResult(domainSourceResp)
}

func (s *dmCustomActionHandlers) getDomainData(ctx context.Context, id string) (*datamesh.QueryDomainDataResponse, error) {
...
func (s *dmCustomActionHandlers) createDomainData(ctx context.Context,
