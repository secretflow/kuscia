...
func (c *hostResourcesController) syncServiceHandler(ctx context.Context, key string) error {
	...
	hExtractedService := utilsres.ExtractService(hServiceCopy)
	...
	mExtractedService := utilsres.ExtractService(mServiceCopy)
	if err = utilsres.PatchService(ctx, c.memberKubeClient, mExtractedService, hExtractedService); err != nil {
