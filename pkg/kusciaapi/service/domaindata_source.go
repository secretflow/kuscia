...
func parseAndNormalizeDataSource(sourceType string, info *kusciaapi.DataSourceInfo) (uri string, err error) {
	...
	case common.DomainDataSourceTypeOSS:
		...
		// truncate slash
		// fix Issue:
		// datasource-path: "/home/admin" ; datasource-prefix: "/test/" ; domainData-relativeURI: "/data/alice.csv" -> "/tests/data/alice.csv"
		// os.path.join(path,prefix,uri) would be /data/alice.csv , this is not expect, expect is /home/admin/tests/data/alice.csv -> /home/admin/test/data/alice.csv
