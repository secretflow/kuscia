	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.KusciaV1alpha1().DataSources(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.KusciaV1alpha1().DataSources(namespace).Watch(context.TODO(), options)
			},
		},
		&kusciav1alpha1.DataSource{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *dataSourceInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&kusciav1alpha1.DataSource{}, f.defaultInformer)
}
