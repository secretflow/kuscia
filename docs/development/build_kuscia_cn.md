...
此处以 Kuscia 0.12.0b0，Secretflow 1.7.0b0 版本为例

```bash
docker build  --build-arg KUSCIA_IMAGE=secretflow-registry.cn-hangzhou.cr.aliyuncs.com/secretflow/kuscia:0.12.0b0  --build-arg  SF_VERSION=1.7.0b0 -f ./kuscia-secretflow.Dockerfile .
```
