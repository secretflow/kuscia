...
| initiator       | string                                       | 否   | 发起方节点 ID                                                                                                                        |
| max_parallelism | int32                                        | 是   | 并发度，参考 [KusciaJob 概念](../concepts/kusciajob_cn.md)                                                                           |
...
| data.status          | [JobStatusDetail](#job-status-detail) | 否   | Job 状态 |
...
| data.jobs | [JobStatus](#job-status)[]      | 否   | Job 状态列表 |
...
| object | [JobStatus](#job-status) | 否   | Job 状态 |
...
| ------ | ------------------------------------- | ---- | ------------ |
| job_id | string                                | 否   | JobID        |
| status | [JobStatusDetail](#job-status-detail) | 否   | Job 状态详情 |
...
| parties           | [Party](#party)[] | 否   | 参与方节点 ID                                                                                                                          |
| alias             | string            | 否   | 任务别名                                                                                                                               |
| task_id           | string            | 否   | 任务 ID，满足 [DNS 子域名规则要求](https://kubernetes.io/zh-cn/docs/concepts/overview/working-with-objects/names/#dns-subdomain-names) |
