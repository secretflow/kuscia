...
_COMMANDDATAMESHQUERY = DESCRIPTOR.message_types_by_name['CommandDataMeshQuery']
_COMMANDDATAMESHUPDATE = DESCRIPTOR.message_types_by_name['CommandDataMeshUpdate']
CommandDataMeshQuery = _reflection.GeneratedProtocolMessageType('CommandDataMeshQuery', (_message.Message,), {
  'DESCRIPTOR' : _COMMANDDATAMESHQUERY,
  '__module__' : 'kuscia.proto.api.v1alpha1.datamesh.flightinner_pb2'
  # @@protoc_insertion_point(class_scope:kuscia.proto.api.v1alpha1.datamesh.CommandDataMeshQuery)
  })
_sym_db.RegisterMessage(CommandDataMeshQuery)

CommandDataMeshUpdate = _reflection.GeneratedProtocolMessageType('CommandDataMeshUpdate', (_message.Message,), {
  'DESCRIPTOR' : _COMMANDDATAMESHUPDATE,
  '__module__' : 'kuscia.proto.api.v1alpha1.datamesh.flightinner_pb2'
  # @@protoc_insertion_point(class_scope:kuscia.proto.api.v1alpha1.datamesh.CommandDataMeshUpdate)
  })
_sym_db.RegisterMessage(CommandDataMeshUpdate)

if _descriptor._USE_C_DESCRIPTORS == False:

  DESCRIPTOR._options = None
  DESCRIPTOR._serialized_options = b'\n org.secretflow.v1alpha1.datameshZ8github.com/secretflow/kuscia/proto/api/v1alpha1/datamesh'
  _COMMANDDATAMESHQUERY._serialized_start=256
  _COMMANDDATAMESHQUERY._serialized_end=495
  _COMMANDDATAMESHUPDATE._serialized_start=498
  _COMMANDDATAMESHUPDATE._serialized_end=740
